...
@section('content')
    <div class="container px-4 py-8 mx-auto">
        <div class="flex flex-col justify-between gap-4 mb-8 sm:flex-row sm:items-center">
            ...
            <a href="{{ route('warehouses.create') }}" class="btn btn-primary">
                <i class="mr-2 ti ti-plus"></i> Add Warehouse
            </a>
        </div>
        ...
        <div class="overflow-hidden bg-white rounded-xl shadow">
            <div class="p-6 border-b border-gray-200">
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <select id="warehouseTable_length" class="select select-bordered select-sm w-20">
                    ...
                    <div class="w-full sm:w-64">
                        <input type="search" id="warehouseSearch" placeholder="Search warehouses..."
            ...
            <div class="overflow-x-auto">
                <table id="warehouseTable" class="w-full">
                    <thead>
                        <tr class="border-b border-gray-200 bg-gray-50">
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                                <a href="#" class="cursor-pointer hover:text-gray-800">Code</a>
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                                <a href="#" class="cursor-pointer hover:text-gray-800">Name</a>
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                                <a href="#" class="cursor-pointer hover:text-gray-800">City</a>
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                                <a href="#" class="cursor-pointer hover:text-gray-800">Phone</a>
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
    ...
    @push('scripts')
        ...
        <script>
            $(function() {
                let dataTable = $('#warehouseTable').DataTable({
                    processing: true,
                    serverSide: true,
                    responsive: true,
                    searching: false,
                    lengthChange: false,
                    ajax: {
                        url: '{{ route('warehouses.datatables') }}',
                        data: function(d) {
                            d.search = {
                                value: $('#warehouseSearch').val()
                            };
                        }
                    },
                    columns: [{
                ...
                // Length change
                $('#warehouseTable_length').on('change', function() {

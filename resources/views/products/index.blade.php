    ...
    <div class="container px-4 py-8 mx-auto">
        <div class="flex flex-col justify-between gap-4 mb-8 sm:flex-row sm:items-center">
            ...
            <a href="{{ route('products.create') }}" class="btn btn-primary">
                <i class="mr-2 ti ti-plus"></i> Add Product
            </a>
        </div>
            ...
            <div class="p-6 border-b border-gray-200">
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <select id="productTable_length" class="select select-bordered select-sm w-20">
                ...
                <table id="productTable" class="w-full">
                    <thead>
                        <tr class="border-b border-gray-200 bg-gray-50">
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                                <a href="#" class="cursor-pointer hover:text-gray-800">Cost</a>
                            </th>
    ...
    @push('scripts')
        ...
        <script>
            $(function() {
                ...
                // Length change
                $('#productTable_length').on('change', function() {

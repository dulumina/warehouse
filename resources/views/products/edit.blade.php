            ...
            <form action="{{ route('products.update', $product) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" id="code" name="code" value="{{ old('code', $product->code) }}"
                            required class="form-control @error('code') is-invalid @enderror">
                        @error('code')
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div>
                        ...
                        <select id="type" name="type" required
                            ...
                            <option value="raw" {{ old('type', $product->type) == 'raw' ? 'selected' : '' }}>Raw
                            </option>
                            <option value="finished" {{ old('type', $product->type) == 'finished' ? 'selected' : '' }}>
                                Finished</option>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div>
                        <label for="max_stock" class="block text-sm font-medium text-gray-700 mb-2">Max Stock <span
                                class="text-red-500">*</span></label>
                        <input type="number" id="max_stock" name="max_stock" step="0.01"
                ...
                <div class="flex gap-3">
                    <button type="submit" class="btn btn-primary">
                        <i class="ti ti-check mr-2"></i> Update Product
                    </button>

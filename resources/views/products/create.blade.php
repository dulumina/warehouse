...
@section('content')
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <select id="type" 
                                            ...
                                            <option value="finished" {{ old('type') == 'finished' ? 'selected' : '' }}>Finished Product</option>
                    ...
                    <div class="p-4">
                        <div class="space-y-3 text-sm">
                            <div>
                                ...
                                <p class="text-gray-600 text-xs">• <strong>Raw:</strong> Materials for production</p>
                                <p class="text-gray-600 text-xs">• <strong>Finished:</strong> Ready to sell</p>
                                <p class="text-gray-600 text-xs">• <strong>Service:</strong> Non-physical items</p>
                            </div>
    ...
    <script>
        ...
        // Price validation (price should be >= cost)

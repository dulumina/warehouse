            ...
            <div>
                <nav class="flex text-sm text-gray-500 mb-2" aria-label="Breadcrumb">
                    <ol class="flex items-center space-x-2">
                        ...
                        <li class="text-gray-800 font-medium">Create Stock Out</li>
                    </ol>
                </nav>
                <h2 class="text-2xl font-bold text-gray-900">Create Stock Out</h2>
                <p class="text-sm text-gray-500 mt-1">Record items leaving the warehouse.</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200/60 overflow-hidden">
            <div class="p-6 sm:p-8">
                <div class="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Stock Out Form</h3>
                    ...
                    <div class="flex gap-4">
                        <a href="{{ route('stock-outs.index') }}" class="inline-flex items-center px-6 py-3 border border-gray-300 text-base font-medium rounded-xl text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all">

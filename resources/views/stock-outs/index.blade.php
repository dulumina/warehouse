...
@section('content')
    <div class="container px-4 py-8 mx-auto">
        <div class="flex flex-col justify-between gap-4 mb-8 sm:flex-row sm:items-center">
            ...
            <a href="{{ route('stock-outs.create') }}" class="btn btn-primary">
                <i class="mr-2 ti ti-plus"></i> Create Stock Out
            </a>
        </div>
        ...
        <div class="overflow-hidden bg-white rounded-xl shadow">
            <div class="p-6 border-b border-gray-200">
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <select id="stockOutTable_length" class="select select-bordered select-sm w-20">
                    ...
                    <div class="w-full sm:w-64">
                        <input type="search" id="stockOutSearch" placeholder="Search..."
            ...
            <div class="overflow-x-auto">
                <table id="stockOutTable" class="w-full">
                    <thead>
    ...
    @push('scripts')
        ...
        <script>
            $(function() {
                let dataTable = $('#stockOutTable').DataTable({
                    processing: true,
                    serverSide: true,
                    responsive: true,
                    searching: false,
                    lengthChange: false,
                    ajax: {
                        url: '{{ route('stock-outs.datatables') }}',
                        data: function(d) {
                            d.search = {
                                value: $('#stockOutSearch').val()
                            };
                        }
                    },
                    columns: [{
                ...
                // Search
                $('#stockOutSearch').on('keyup', function() {
                    dataTable.draw();
                });

                // Length change
                $('#stockOutTable_length').on('change', function() {

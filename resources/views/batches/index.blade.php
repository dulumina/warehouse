...
@section('content')
    <div class="container px-4 py-8 mx-auto">
        <h1 class="mb-6 text-3xl font-bold text-gray-900">Batches</h1>
        ...
        <div class="overflow-hidden bg-white rounded-xl shadow">
            <div class="p-6 border-b border-gray-200">
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <select id="batchTable_length" class="select select-bordered select-sm w-20">
                    ...
                    <div class="w-full sm:w-64">
                        <input type="search" id="batchSearch" placeholder="Search batches..."
            ...
            <div class="overflow-x-auto">
                <table id="batchTable" class="w-full">
                    <thead>
                        <tr class="border-b border-gray-200 bg-gray-50">
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                                <a href="#" class="cursor-pointer hover:text-gray-800">Batch Number</a>
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                                <a href="#" class="cursor-pointer hover:text-gray-800">Product</a>
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                                <a href="#" class="cursor-pointer hover:text-gray-800">Expiry</a>
                            </th>
                            <th class="px-6 py-3 text-right text-xs font-medium text-gray-600 uppercase tracking-wider">
                                <a href="#" class="cursor-pointer hover:text-gray-800">Qty</a>
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
    ...
    @push('scripts')
        ...
        <script>
            $(function() {
                let dataTable = $('#batchTable').DataTable({
                    processing: true,
                    serverSide: true,
                    responsive: true,
                    searching: false,
                    lengthChange: false,
                    ajax: {
                        url: '{{ route('batches.datatables') }}',
                        data: function(d) {
                            d.search = {
                                value: $('#batchSearch').val()
                            };
                        }
                    },
                    columns: [{
                ...
                // Length change
                $('#batchTable_length').on('change', function() {

    ...
    <div class="container px-4 py-8 mx-auto">
        <div class="flex flex-col justify-between gap-4 mb-8 sm:flex-row sm:items-center">
            ...
            <a href="{{ route('categories.create') }}" class="btn btn-primary">
                <i class="mr-2 ti ti-plus"></i> Add Category
            </a>
        </div>
            ...
            <div class="p-6 border-b border-gray-200">
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <select id="categoryTable_length" class="select select-bordered select-sm w-20">
    ...
    @push('scripts')
        ...
        <script>
            $(function() {
                ...
                // Length change
                $('#categoryTable_length').on('change', function() {

...
@section('content')
    <div class="container px-4 py-8 mx-auto">
        <div class="flex flex-col justify-between gap-4 mb-8 sm:flex-row sm:items-center">
            <h1 class="text-3xl font-bold text-gray-900">Stock Transfer</h1>
            <a href="{{ route('stock-transfers.create') }}" class="btn btn-primary">
                <i class="mr-2 ti ti-plus"></i> Create Transfer
            </a>
        </div>
            ...
            <div class="p-6 border-b border-gray-200">
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <select id="transferTable_length" class="select select-bordered select-sm w-20">
                    ...
                    <div class="w-full sm:w-64">
                        <input type="search" id="transferSearch" placeholder="Search..."
                ...
                <table id="transferTable" class="w-full">
                    <thead>
                        <tr class="border-b border-gray-200 bg-gray-50">
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                                <a href="#" class="cursor-pointer hover:text-gray-800">From</a>
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                                <a href="#" class="cursor-pointer hover:text-gray-800">To</a>
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
    ...
    @push('scripts')
        ...
        <script>
            $(function() {
                let dataTable = $('#transferTable').DataTable({
                    processing: true,
                    serverSide: true,
                    responsive: true,
                    searching: false,
                    lengthChange: false,
                    ajax: {
                        url: '{{ route('stock-transfers.datatables') }}',
                        data: function(d) {
                            d.search = {
                                value: $('#transferSearch').val()
                            };
                        }
                    },
                    columns: [{
                ...
                // Length change
                $('#transferTable_length').on('change', function() {

...
@section('content')
    <div class="container px-4 py-8 mx-auto">
        <div class="flex flex-col justify-between gap-4 mb-8 sm:flex-row sm:items-center">
            ...
            <a href="{{ route('stock-adjustments.create') }}" class="btn btn-primary">
                <i class="mr-2 ti ti-plus"></i> Create Adjustment
            </a>
        </div>
        ...
        <div class="overflow-hidden bg-white rounded-xl shadow">
            <div class="p-6 border-b border-gray-200">
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <select id="adjustmentTable_length" class="select select-bordered select-sm w-20">
                    ...
                    <div class="w-full sm:w-64">
                        <input type="search" id="adjustmentSearch" placeholder="Search..."
            ...
            <div class="overflow-x-auto">
                <table id="adjustmentTable" class="w-full">
                    <thead>
                        <tr class="border-b border-gray-200 bg-gray-50">
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                                <a href="#" class="cursor-pointer hover:text-gray-800">Document #</a>
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                                <a href="#" class="cursor-pointer hover:text-gray-800">Warehouse</a>
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                                <a href="#" class="cursor-pointer hover:text-gray-800">Type</a>
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                                <a href="#" class="cursor-pointer hover:text-gray-800">Status</a>
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                                <a href="#" class="cursor-pointer hover:text-gray-800">Date</a>
                            </th>
    ...
    @push('scripts')
        ...
        <style>
            #adjustmentTable tbody tr:hover {
        ...
        <script>
            $(function() {
                let dataTable = $('#adjustmentTable').DataTable({
                    processing: true,
                    serverSide: true,
                    responsive: true,
                    searching: false,
                    lengthChange: false,
                    ajax: {
                        url: '{{ route('stock-adjustments.datatables') }}',
                        data: function(d) {
                            d.search = {
                                value: $('#adjustmentSearch').val()
                            };
                        }
                    },
                    columns: [{
                ...
                // Length change
                $('#adjustmentTable_length').on('change', function() {
